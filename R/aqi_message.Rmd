...
# Flip to tall table
names(lead_board)[c(1:6,13)] <- c("Model", "Mean error ugm3|ppb", "On target %", 
...
names(lead_board_pm) <- c("Model", "Mean error ugm3|ppb", "On target %", 
...
if (ozone_season) {
  ...
  lead_board <- formattable(lead_board,
                            list(Model                   = margin_right(24),
                                 ...
                                 `Mean error ugm3|ppb`   = margin_right(70),
  ...
  lead_board <- formattable(filter(lead_board, Pollutant == "PM25"),
                            list(Model                   = margin_right(24),
                                 Pollutant               = margin_right(50),
                                 `Mean error ug/m3`      = margin_right(70),
                                 `On target %`           = margin_right(99),
                                 `Bullseyes`             = margin_right(90),
                                 `Cat accuracy`          = margin_right(99),
                                 `Yellow accuracy`       = margin_right(120)),
...
#yest_board[ifelse(ozone_season, 10, 9), 1] <- "BB3 Blender"
...
pm_board <- subset(lead_board, Pollutant == "PM25") %>%
            rename(`Mean error ugm3` = `Mean error ugm3|ppb`)
...
if (ozone_season) {
  ...
  o3_board <- subset(lead_board, Pollutant == "ozone") %>%
              rename(`Mean error ppb` = `Mean error ugm3|ppb`)
