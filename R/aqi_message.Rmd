...
<div style="margin-top: -20px; font-size: 18px; font-weight: 700; color: #606060;">
`r format(Sys.Date() - 1, "%A %b %d, %Y")`</div>  
...
cat(". View this weeks complete modeling performance at [AQI Watch](http://ec2-34-216-61-109.us-west-2.compute.amazonaws.com/model_perf.html). \n")
