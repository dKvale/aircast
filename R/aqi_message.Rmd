...
aqi_colors <- c("#53BF33" = "#53BF33", "#FFEE00" = "#FFEE00", "#DB6B1A" = "#DB6B1A")
...
# Leader board
#lead_board <- data_frame(Model            = c("MPCA MET Team", "Dr Robot", "CMAQ"),
