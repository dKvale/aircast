...
<div style="margin-top: -19px; font-size: 16px;"> Preliminary results for `r format(Sys.Date() - 1, "%A %b %d, %Y")`</div>  
...
if (ozone_season) {
  # Save to PNG image
  png("C:/Users/dkvale/Desktop/credents/fcst_regression.png", width = 1300, height = 700, res = 300)
  # Set 2 plots per row
