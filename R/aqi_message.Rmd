...
if (!weekend) {
  ...
  if (!ozone_season) {
     ...
     if ("new O3 error ppb" %in% names(yest_board) &&  is.na(yest_board[lead_board$Model == "CMAQ", ]$`new O3 error ppb`)) lead_board[6, "O3 Forecasts"] <- 0
     ...
     lead_board <- lead_board %>% 
                     ...
                     mutate(new_obs        = !is.na(`new PM error ug/m3`),
                            ...
                            new_obs        = !is.na(`new O3 error ug/m3`),
