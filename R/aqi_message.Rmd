...
<div style="margin-top: -20px; font-size: 18px; font-weight: 700;">`r format(Sys.Date() - 1, "%A %b %d, %Y")`</div>  
...
cat(paste0('The category accuracy of the next-day forecast was __', round(pm_performance[5, ]$accuracy), '%__ (', sum(filter(tall_pm, !is.na(aqi), model == 'MPCA forecast')$fcst_correct, na.rm = T), '/', pm_performance[1, ]$n_preds, ') for PM2.5'))
