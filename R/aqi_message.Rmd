...
if (!weekend) {
  ...
  if (!ozone_season) {
     ...
     if ("new O3 error ppb" %in% names(yest_board) &&  is.na(yest_board[lead_board$Model == "CMAQ", ]$`new O3 error ppb`)) lead_board$new_obs[6] <- 0
...
if (ncol(yest_board) > 8) {
  ...
  yest_board[yest_board$Model == "CMAQ", 
             c("PM error ug/m3", "PM on target %", "PM bullseyes %", "PM cat accuracy %", "PM yellow accuracy %")] <- " "
