...
names(verify_o3)[4:6] <- c("Obs count", "Obs AQI", "Forecast AQI")
...
formatter("span", 
            style = x ~ style("padding-left"  = "30px",
                              "padding-right" = "30px",
...
verify_o3 <- formattable(verify_o3, align = c("l","r","r","r","r","r"),
                         list(Site              = margin_left(0),
                              Group             = margin_left(20),
                              `AQS ID`          = margin_left(20),
                              `Obs count`       = margin_left(55),
...
names(verify_pm)[4:6] <- c("Obs count", "Obs AQI", "Forecast AQI")
