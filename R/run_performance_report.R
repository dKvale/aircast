...
verify <- read_csv("X:/Agency_Files/Outcomes/Risk_Eval_Air_Mod/_Air_Risk_Evaluation/Staff Folders/Dorian/AQI/Verification/Archive/2017_verification_table.csv")
...
day1 <- filter(fond, forecast_day == 1) %>% 
        mutate(correct = (mod_pm25avg < 12.1 & obs_pm25_ugm3 < 12.1) |  (mod_pm25avg >= 12.1 & obs_pm25_ugm3 >= 12.1))
